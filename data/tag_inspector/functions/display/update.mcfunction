...
execute unless data storage tag_inspector: {tags:[]} run data modify entity @s text set value '{"translate":"%s","with":[{"nbt":"tags[]","storage":"tag_inspector:","color":"green","separator":"\\n"}]}'