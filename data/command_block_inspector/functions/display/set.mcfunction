...
#コマブロがあったらディスプレイの召喚
execute unless entity @e[tag=cbi.display,distance = ..0.49] if block ~ ~ ~ #command_block_inspector:command_blocks run function command_block_inspector:display/set_sub
